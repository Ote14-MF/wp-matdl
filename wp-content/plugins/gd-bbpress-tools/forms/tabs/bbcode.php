...
<form action="" method="post">
    ...
    <div class="d4p-settings">
        ...
        <fieldset>
            ...
            <p style="font-weight: bold;"><?php _e("If you are using BuddyPress Nuovo templates, BBCode for Italic can cause the problem with some elements of the BuddyPress using underscore templates to render. To avoid that, you need to enable this option, or disable Italic BBCode.", "gd-bbpress-tools"); ?></p>
        </fieldset>
        ...
        <fieldset>
            ...
            <p><?php _e("By default all BBCodes are active. If you want, you can disable registration of any of the BBCodes. To do that, just uncheck the BBCodes you want to deactivate from the list under.", "gd-bbpress-tools"); ?></p>
